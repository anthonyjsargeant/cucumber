...
When(/^we get the customer's details using account number (\d+)$/, function (accountNumber) {
...
Then(/^the bank should throw an error with the following message:$/, function (table) {
  const tableData = table.hashes()
