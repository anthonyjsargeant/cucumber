...
module.exports = class Bank {
  ...
  getAccountByAccountNumber (accountNumber) {
    const bankAccount = this.bankAccounts.find(account => account.accountNumber === accountNumber)
  ...
  createAccount (accountNumber, firstName, lastName, emailAddress, initialDeposit) {
    const bankAccount = new BankAccount(accountNumber, firstName, lastName, emailAddress)
